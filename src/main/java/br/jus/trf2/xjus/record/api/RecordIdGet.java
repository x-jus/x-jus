...
public class RecordIdGet implements IXjusRecordAPI.IRecordIdGet {
	...
	public void run(RecordIdGetRequest req, RecordIdGetResponse resp) throws Exception {
		...
		if ("0000000001".equals(req.id)) {
		...
		} else if ("0000000002".equals(req.id)) {
			...
			addField(resp, "Autor", "Desconhecido");
			addFacet(resp, "Autor", "Desconhecido");
		} else if ("0000000003".equals(req.id)) {
		...
		} else if ("0000000004".equals(req.id)) {
